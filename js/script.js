			...
			if (vInput.startsWith("./")) {
				...
				if (typeof loginArray[2] !== "undefined") {
					if (loginArray[2] === "visitor") {
						...
						if (typeof loginArray[4] !== "undefined" && MD5(loginArray[4]) === "5f4dcc3b5aa765d61d8327deb882cf99") {
							root = 1;
							res = '';
						}
					} else {
