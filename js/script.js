...
$(function()
{
	$(document).keydown(function(objEvent) 
	{
		if (objEvent.ctrlKey && !enableKeys) 
		{
			...
			{
				if (objEvent.keyCode == 73 || objEvent.keyCode == 74 || objEvent.keyCode == 67) return false; // CTRL + SHIFT + I / J / C
			} 
			else 
			{
				if (objEvent.keyCode == 65 || objEvent.keyCode == 85) return false;// CTRL + A / U
			}
        	}
		if (objEvent.keyCode == 123) return false;// F12
	});
});
